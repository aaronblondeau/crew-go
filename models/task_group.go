...
func init() {
	fmt.Println("Models package initialized - do db migrations?")
}

// A TaskGroupEvent notifies listeners of changes to a TaskGroup's state.
...
type TaskGroup struct {
	...
	Events chan TaskGroupEvent `json:"-"`
}
